...
export default defineSchema({
  ...
  // ============================================
  // PHASE II: Banking/Stocks/Loans/Sunspots REMOVED
  // Tables deleted: bankAccounts, stockCompanies, stockPriceHistory,
  // stockHoldings, stockTransactions, investments, loans, bankTransactions,
  // interestRates, sunspotData, sunspotCommitments, goldEscrow,
  // goldTransactions, solarFlares (14 tables total)
  // ============================================
  ...
  // NOTE: discordTodos table REMOVED (Discord bot integration removed)
