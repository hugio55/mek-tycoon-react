// Migration script to apply old desktop settings to new unified table
...
console.log('Desktop config:', JSON.stringify(oldDesktopConfig, null, 2));
console.log('Shared config:', JSON.stringify(sharedConfig, null, 2));
