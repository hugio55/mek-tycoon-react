...
import { useQuery, useMutation } from '@/providers/ConvexProviderWithLoader';
  ...
  return (
    <Tooltip.Provider delayDuration={200}>
      <div className="flex flex-col text-white relative" style={{ minHeight: '100vh' }}>
        ...
        <footer className="flex-shrink-0 w-full bg-black/40 backdrop-blur-md border-t border-yellow-500/20" style={{ height: '150px' }}>
            ...
            <div className="flex items-center gap-8">
              ...
              <div className="flex items-center gap-3">
                <img
                  ...
                  alt="Over Exposed"
                  className="h-12 w-auto opacity-60 hover:opacity-100 transition-opacity cursor-pointer"
                  onClick={() => window.open('https://overexposed.io', '_blank')}
                />
              </div>
              ...
              <div className="flex items-center gap-4">
                ...
                {/* X (Twitter) */}
                <a
                  href="https://twitter.com/OverExposed_NFT"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-gray-400 hover:text-yellow-400 transition-colors"
                >
