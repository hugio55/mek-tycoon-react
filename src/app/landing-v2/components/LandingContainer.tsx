  ...
  return (
    ...
    >
      ...
      <div className="relative w-full flex flex-col min-h-screen pb-8" style={{ zIndex: 10 }}>
        ...
        {showFooter && (
          <footer className="w-full py-12 relative mt-16">
              ...
              <svg width="100%" height="100%" xmlns="http://www.w3.org/2000/svg">
                <defs>
                  <pattern id="honeycomb" x="0" y="0" width="56" height="100" patternUnits="userSpaceOnUse">
                    <polygon points="28,0 56,14 56,42 28,56 0,42 0,14" fill="none" stroke="#fab617" strokeWidth="1"/>
                    <polygon points="28,56 56,70 56,98 28,112 0,98 0,70" fill="none" stroke="#fab617" strokeWidth="1"/>
                  </pattern>
