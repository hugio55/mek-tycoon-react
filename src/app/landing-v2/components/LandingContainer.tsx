      ...
      <div className="relative w-full flex flex-col min-h-screen" style={{ zIndex: 10 }}>
        ...
        >
            ...
            <svg className="absolute inset-0 w-full h-full pointer-events-none">
              <defs>
                <pattern id="honeycomb" width="28" height="49" patternUnits="userSpaceOnUse">
                  <path d="M14 0 L21 4 L21 12 L14 16 L7 12 L7 4 Z" fill="none" stroke="rgba(255,255,255,0.16)" strokeWidth="0.5"/>
                  <path d="M0 24.5 L7 28.5 L7 36.5 L0 40.5 L-7 36.5 L-7 28.5 Z" fill="none" stroke="rgba(255,255,255,0.16)" strokeWidth="0.5"/>
                  <path d="M28 24.5 L35 28.5 L35 36.5 L28 40.5 L21 36.5 L21 28.5 Z" fill="none" stroke="rgba(255,255,255,0.16)" strokeWidth="0.5"/>
                </pattern>
            ...
            <div className="relative z-10 flex flex-col items-center gap-px">
              ...
              {/* Social Icons */}
              <div className="flex items-center gap-6 scale-[0.792]">
                <a
