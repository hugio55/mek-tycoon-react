        ...
        >
          ...
          {isPhaseOne && (
            <div className="mt-6 flex justify-start">
              <div className="overflow-hidden inline-block" style={{ filter: 'none' }}>
                <HolographicButton
                  text="CLAIM NFT"
                  onClick={() => {
                  ...
                  alwaysOn={true}
                  hideIcon={true}
                  className="!px-4 !py-1 [&_span]:!text-xs [&_span]:!tracking-wide scale-75 origin-left [&>div>div]:!shadow-none"
                />
              </div>
            </div>
          )}
