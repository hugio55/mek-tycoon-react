...
export default function MekLayoutsPage() {
  ...
  // Helper function to render variation text based on selected style
  const renderVariationText = (category: string, name: string, count: number, total: number, base: number, bonus: number) => {
      ...
      case 'tech-readout':
        ...
        return (
          <div className="w-full font-mono text-left space-y-1" style={{ fontFamily: 'JetBrains Mono' }}>
            <div className="text-[10px] text-white/40 uppercase tracking-wider">{category}</div>
  ...
  return (
    <div className="min-h-screen text-white flex flex-col items-center p-4">
      ...
      {/* Mek Variations Display */}
      <div className="w-full max-w-6xl mb-16">
        <h2 className="text-3xl font-bold text-yellow-400 uppercase tracking-wider font-orbitron text-center mb-8">
          Mek Variations
        </h2>

        {/* Grid of 3 variations */}
        <div className="grid grid-cols-3 gap-8">
          {/* Head Variation */}
          <div className="flex flex-col items-center">
            {/* Mek Image */}
            <div
              className="w-full aspect-square bg-gradient-to-br from-orange-900/30 to-black/50 rounded-lg mb-4 flex items-center justify-center relative overflow-hidden"
              style={{
                filter: `drop-shadow(0 0 ${variationGlowSize}px rgba(250, 182, 23, ${variationGlowIntensity}))`
              }}
            >
              <div className="text-6xl">🤖</div>
            </div>

            {/* Text Content - Style Variations */}
            {renderVariationText('HEAD VARIATION', 'Variation Name', 3, 4000, 100, 25)}
          </div>
          ...
          <div className="flex flex-col items-center">
            {/* Mek Image */}
            <div
              className="w-full aspect-square bg-gradient-to-br from-gray-700/30 to-black/50 rounded-lg mb-4 flex items-center justify-center relative overflow-hidden"
              style={{
                filter: `drop-shadow(0 0 ${variationGlowSize}px rgba(250, 182, 23, ${variationGlowIntensity}))`
              }}
            >
            ...
            {/* Text Content - Style Variations */}
            {renderVariationText('BODY VARIATION', 'Variation Name', 3, 4000, 100, 25)}
          </div>
          ...
          <div className="flex flex-col items-center">
            {/* Mek Image */}
            <div
              className="w-full aspect-square bg-gradient-to-br from-purple-900/30 to-black/50 rounded-lg mb-4 flex items-center justify-center relative overflow-hidden"
              style={{
                filter: `drop-shadow(0 0 ${variationGlowSize}px rgba(250, 182, 23, ${variationGlowIntensity}))`
              }}
            >
            ...
            {/* Text Content - Style Variations */}
            {renderVariationText('TRAIT VARIATION', 'Variation Name', 3, 4000, 100, 25)}
          </div>
        </div>
      </div>
