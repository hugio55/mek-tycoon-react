      ...
      <div className="relative z-10 h-screen flex flex-col">
        ...
        <div className="relative mek-card-industrial mek-border-sharp-gold py-2 px-4 mek-glow-yellow mx-4 mt-4 mb-2">
          ...
          <div className="relative flex items-center justify-between">
            ...
            {(() => {
              const myListingsCount = debugListingCount; // Use debug count for testing
              const hasListings = myListingsCount > 0;

              switch (buttonVariation) {
                case 1: // Industrial Stack - Vertical emphasis
                  return (
                    <div className="flex flex-col gap-1">
                      <div className="flex gap-2 items-center">
                        {/* LIST ITEM - Yellow, most prominent */}
                        <button
                        ...
                        {/* MY LISTINGS - Green when active, gray when empty */}
                        <button
                        ...
                        {/* BOUNTIES - Purple accent */}
                        <button
                          onClick={() => console.log('Bounties clicked')}
                ...
                case 3: // Minimal Modern
                  return (
                    <div className="flex gap-2 items-center">
                      {/* LIST ITEM - Clean yellow, largest */}
                      <button
                        onClick={() => setShowCreateListing(true)}
                      ...
                      {/* MY LISTINGS - Outline when empty, filled when active */}
                      <button
                        onClick={() => setShowMyListings(!showMyListings)}
                      ...
                      >
                        MY LISTINGS {hasListings && `(${myListingsCount})`}
                      </button>
            ...
            <div className="relative z-10 flex flex-col h-full">
              ...
              <div className="absolute top-2 right-2 z-20 flex flex-col gap-2">
                ...
                <select
                  ...
                  className="px-2 py-1 bg-black/90 border border-yellow-500/50 rounded text-yellow-400 text-[9px] font-bold"
                >
                  <option value={1}>Button Style 1: Industrial Stack</option>
                  <option value={2}>Button Style 2: Angled Chips</option>
                  <option value={3}>Button Style 3: Minimal Modern</option>
                  <option value={4}>Button Style 4: Retro Arcade</option>
                  <option value={5}>Button Style 5: Industrial Tags</option>
                </select>
                  ...
                  <button
                    ...
                    className={`px-2 py-1 text-[9px] font-bold rounded ${
                      debugListingCount === 0
                        ...
                        : 'bg-black/80 border border-gray-700 text-gray-400 hover:border-yellow-500/50'
                    }`}
                  >
                    0 Listings
                  </button>
