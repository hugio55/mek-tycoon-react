    ...
    <div className="min-h-screen bg-black text-white overflow-hidden relative">
      ...
      <style jsx global>{`
        ...
        @keyframes floatParticle {
          0% { transform: translateY(0px) translateX(0px) scale(0.8); opacity: 0.5; }
          33% { transform: translateY(-30px) translateX(15px) scale(1); opacity: 1; }
          66% { transform: translateY(15px) translateX(-15px) scale(0.9); opacity: 0.7; }
          100% { transform: translateY(0px) translateX(0px) scale(0.8); opacity: 0.5; }
        }
