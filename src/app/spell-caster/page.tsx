    ...
    const animate = () => {
      ...
      particlesRef.current = particlesRef.current.filter(particle => {
        ...
        if (particle.glow && particle.life > 0.3) {
          ...
          gradient.addColorStop(0, `hsla(${particle.hue || 0}, ${particle.saturation || 100}%, ${particle.lightness || 50}%, 1)`)
          gradient.addColorStop(1, `hsla(${particle.hue || 0}, ${particle.saturation || 100}%, ${particle.lightness || 50}%, 0)`)
