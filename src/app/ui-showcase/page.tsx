...
import { textGlow } from '@/lib/typography';
        ...
        <section className="mb-12">
          ...
          <Card padding="lg">
            <div className="space-y-8">
              ...
              {/* Contextual Examples by Page */}
              <div className="border-t border-gray-800 pt-6 mt-8">
                <h3 className="text-lg font-semibold text-yellow-300 mb-4">CONTEXTUAL EXAMPLES BY PAGE</h3>
                <p className="text-xs text-gray-500 mb-4">Font combinations for different game contexts</p>

                <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                  {/* Hub Example */}
                  <div className="bg-gradient-to-b from-gray-900/50 to-gray-900/20 p-6 rounded-lg border border-yellow-500/30">
                    <h4 className="font-michroma text-xl text-yellow-400 mb-3">HUB COMMAND</h4>
                    <div className="space-y-2">
                  ...
                  <div className="bg-gradient-to-b from-red-900/20 to-gray-900/20 p-6 rounded-lg border border-red-500/30">
                    <h4 className="font-blackops text-xl text-red-400 mb-3">COMBAT ZONE</h4>
                    <div className="space-y-2">
                  ...
                  <div className="bg-gradient-to-b from-blue-900/20 to-gray-900/20 p-6 rounded-lg border border-blue-500/30">
                    <h4 className="font-exo text-xl text-blue-400 mb-3">MARKETPLACE</h4>
                    <div className="space-y-2">
                  ...
                  <div className="bg-gradient-to-b from-purple-900/20 to-gray-900/20 p-6 rounded-lg border border-purple-500/30">
                    <h4 className="font-audiowide text-xl text-purple-400 mb-3">WORKSHOP</h4>
                    <div className="space-y-2">
                  ...
                  <div className="bg-gradient-to-b from-yellow-900/20 to-gray-900/20 p-6 rounded-lg border border-yellow-500/30">
                    <h4 className="font-bebas text-2xl text-yellow-400 mb-3 tracking-wider">LEADERBOARD</h4>
                    <div className="space-y-2">
                  ...
                  <div className="bg-gradient-to-b from-green-900/20 to-gray-900/20 p-6 rounded-lg border border-green-500/30">
                    <h4 className="font-jetbrains text-xl text-green-400 mb-3">ADMIN PANEL</h4>
                    <div className="space-y-2">
              ...
              {/* Button Typography */}
              <div className="border-t border-gray-800 pt-6 mt-8">
                <h3 className="text-lg font-semibold text-yellow-300 mb-4">BUTTON TYPOGRAPHY</h3>
              ...
              {/* Special Effects */}
              <div className="border-t border-gray-800 pt-6 mt-8">
                <h3 className="text-lg font-semibold text-yellow-300 mb-4">TYPOGRAPHY EFFECTS</h3>

                <div className="grid md:grid-cols-2 gap-8">
                  <div className="bg-gray-900/30 p-6 rounded-lg border border-gray-800">
                    <h4 className="text-lg font-bold text-cyan-400 mb-6">Text Effects</h4>

                    <div className="space-y-4">
                      <div>
                        <button
                          onClick={() => setActiveEffect(activeEffect === 'glitch' ? '' : 'glitch')}
                          className="text-xs bg-gray-700 text-gray-300 px-3 py-1 rounded mb-2"
                        >
                          Toggle Glitch
                        </button>
                        <h5
                      ...
                      <div>
                        ...
                        <h5 className={`font-russo text-2xl text-orange-400 ${activeEffect === 'distort' ? 'typo-distort' : ''}`}>
                          UNSTABLE FIELD
                        </h5>
                      </div>
                      ...
                      <div>
                        ...
                        <h5 className={`font-michroma text-2xl text-blue-400 ${activeEffect === 'scan' ? 'typo-scan' : ''}`}>
                          SCANNING DATA
                        </h5>
                      </div>
                    </div>
                  ...
                  <div className="bg-gray-900/30 p-6 rounded-lg border border-gray-800">
                    <h4 className="text-lg font-bold text-purple-400 mb-6">Text Glow Effects</h4>
              ...
              <div className="border-t border-gray-800 pt-6 mt-8">
                <h3 className="text-lg font-semibold text-yellow-300 mb-4">FONT COMPARISON TABLE</h3>

                <div className="overflow-x-auto">
                  <table className="w-full bg-gray-900/30 border border-gray-800">
                    <thead>
                      <tr className="border-b border-gray-700">
                        <th className="p-4 text-left text-xs text-gray-400 uppercase tracking-wider">Font Name</th>
                        <th className="p-4 text-left text-xs text-gray-400 uppercase tracking-wider">Best Use Case</th>
                        <th className="p-4 text-left text-xs text-gray-400 uppercase tracking-wider">Sample</th>
                      </tr>
                    </thead>
                    <tbody>
                      <tr className="border-b border-gray-800">
                        <td className="p-4 text-gray-300">Michroma</td>
                        <td className="p-4 text-gray-400">Hero titles, main branding</td>
                        <td className="p-4 font-michroma text-yellow-400 text-xl">ADVANCED SYSTEMS</td>
                      </tr>
                      <tr className="border-b border-gray-800">
                        <td className="p-4 text-gray-300">Audiowide</td>
                        <td className="p-4 text-gray-400">Section headers, emphasis</td>
                        <td className="p-4 font-audiowide text-yellow-400 text-xl">TACTICAL DISPLAY</td>
                      </tr>
                      <tr className="border-b border-gray-800">
                        <td className="p-4 text-gray-300">Russo One</td>
                        <td className="p-4 text-gray-400">Military/combat UI</td>
                        <td className="p-4 font-russo text-yellow-400 text-xl">DEFENSE PROTOCOL</td>
                      </tr>
                      <tr className="border-b border-gray-800">
                        <td className="p-4 text-gray-300">Black Ops One</td>
                        <td className="p-4 text-gray-400">Warnings, military alerts</td>
                        <td className="p-4 font-blackops text-yellow-400 text-xl">CRITICAL ALERT</td>
                      </tr>
                      <tr className="border-b border-gray-800">
                        <td className="p-4 text-gray-300">Exo 2</td>
                        <td className="p-4 text-gray-400">Clean UI, shop/market</td>
                        <td className="p-4 font-exo text-yellow-400 text-xl">Market Interface</td>
                      </tr>
                      <tr className="border-b border-gray-800">
                        <td className="p-4 text-gray-300">Saira</td>
                        <td className="p-4 text-gray-400">Body text, UI labels</td>
                        <td className="p-4 font-saira text-yellow-400 text-xl">Interface Elements</td>
                      </tr>
                      <tr className="border-b border-gray-800">
                        <td className="p-4 text-gray-300">Space Grotesk</td>
                        <td className="p-4 text-gray-400">Descriptions, readable text</td>
                        <td className="p-4 font-space text-yellow-400 text-xl">System Information</td>
                      </tr>
                      <tr className="border-b border-gray-800">
                        <td className="p-4 text-gray-300">Oxanium</td>
                        <td className="p-4 text-gray-400">Labels, small UI text</td>
                        <td className="p-4 font-oxanium text-yellow-400 text-xl">STATUS INDICATOR</td>
                      </tr>
                      <tr className="border-b border-gray-800">
                        <td className="p-4 text-gray-300">JetBrains Mono</td>
                        <td className="p-4 text-gray-400">Data, numbers, code</td>
                        <td className="p-4 font-jetbrains text-yellow-400 text-xl">1,234,567.89</td>
                      </tr>
                      <tr className="border-b border-gray-800">
                        <td className="p-4 text-gray-300">Share Tech Mono</td>
                        <td className="p-4 text-gray-400">Technical readouts</td>
                        <td className="p-4 font-sharetech text-yellow-400 text-xl">SYSTEM.STATUS.OK</td>
                      </tr>
                      <tr className="border-b border-gray-800">
                        <td className="p-4 text-gray-300">Teko</td>
                        <td className="p-4 text-gray-400">Large numbers, timers</td>
                        <td className="p-4 font-teko text-yellow-400 text-3xl">12:34:56</td>
                      </tr>
                      <tr className="border-b border-gray-800">
                        <td className="p-4 text-gray-300">Bebas Neue</td>
                        <td className="p-4 text-gray-400">Impact text, headlines</td>
