    ...
    <div className="space-y-6">
      ...
      <div className="bg-gray-800/30 border border-gray-700 rounded-lg p-4 text-sm text-gray-500">
        ...
        <ul className="list-disc list-inside space-y-2">
          ...
          <li><span className="text-gray-400">Deploy Dev (Trout)</span> - Updates Convex functions on staging database (safe to test)</li>
          <li><span className="text-gray-400">Deploy Prod (Sturgeon)</span> - Updates Convex functions on production database (affects live users)</li>
        </ul>
