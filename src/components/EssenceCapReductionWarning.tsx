    ...
    >
      ...
      >
        ...
        <div className="border-t-2 border-red-500/30 bg-black/60 p-6 flex gap-4">
          ...
          <button
            onClick={onConfirm}
            className="flex-1 px-6 py-3 border-2 rounded font-bold uppercase tracking-wider transition-all bg-red-600/50 border-red-500 text-red-300 hover:bg-red-600/70 hover:border-red-400"
          >
            Continue Anyway
          </button>
        </div>
