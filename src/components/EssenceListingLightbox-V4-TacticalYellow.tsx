...
// VERSION 4: DARK TACTICAL (YELLOW)
// Same as V3 but with yellow accent color instead of blue
...
export default function EssenceListingLightboxV4TacticalYellow({
  show,
  onClose,
  onSubmit,
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <select
                ...
                className="w-full px-3 py-2.5 bg-gray-900 border border-gray-800 text-gray-300 text-sm focus:border-yellow-600 focus:outline-none transition-colors"
              >
                ...
                {["10000", "1000", "100", "10", "1"].map((place, idx) => (
                  <div key={place} className="flex flex-col items-center">
                    <button
                      ...
                      className="w-11 h-7 flex items-center justify-center bg-gray-800 hover:bg-gray-700 border-t border-x border-gray-700 text-gray-400 hover:text-yellow-400 transition-all text-xs"
                    >
                      ▴
                    </button>
                    ...
                    <button
                      ...
                      className="w-11 h-7 flex items-center justify-center bg-gray-800 hover:bg-gray-700 border-b border-x border-gray-700 text-gray-400 hover:text-yellow-400 transition-all text-xs"
                    >
                      ▾
                    </button>
            ...
            <div>
              ...
              <div className="mt-2 text-xs text-gray-500">
                Listing fee:{" "}
                <span className="text-yellow-400 font-medium">{listingFee}g</span>
              </div>
            </div>
            ...
            <div className="flex gap-2 pt-2">
              <button
                ...
                className="flex-1 py-3 bg-yellow-600 hover:bg-yellow-500 text-white font-medium transition-colors"
              >
                Deploy Listing
              </button>
              <button
