...
export default function GoldGenerationDetailsLightbox({ isOpen, onClose, layout = 'classic' }: GoldGenerationDetailsLightboxProps) {
  ...
  const modalContent = (
    <div className="fixed inset-0 z-[9999] flex items-center justify-center p-4" onClick={onClose}>
      ...
      {/* Lightbox Container */}
      <div
        className="relative w-[600px] max-w-[95vw] max-h-[90vh] bg-black/20 backdrop-blur-md border-2 border-yellow-500/50 rounded-lg overflow-hidden shadow-2xl flex flex-col z-10"
