...
export default function MekCarousel3D({
  ...
  const containerHeight = sizeStyle.height * 2.5;
          ...
          {images.map((src, index) => (
            <div
              ...
              style={{
                ...
                boxShadow: `0 0 20px ${config.glow}, inset 0 0 30px ${config.gradientInner}`
              }}
            >
              ...
              <div
                style={{
                  ...
                  height: '100%',
                  position: 'relative',
                  background: `radial-gradient(circle, ${config.gradientInner} 0%, ${config.gradientMid} 60%, ${config.gradientOuter} 100%)`
                }}
              >
                <Image
                  src={src}
                ...
                <div
                  style={{
                    position: 'absolute',
                    inset: 0,
                    background: `radial-gradient(circle, transparent 0%, ${config.gradientInner} 60%, ${config.gradientMid} 100%)`,
