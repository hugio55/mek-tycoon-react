          ...
          <div className="mb-4 border-t border-gray-700 pt-3">
            <label className="flex items-center gap-2 cursor-pointer mb-2">
              <input
                ...
                className="w-4 h-4"
              />
              <span className="text-xs text-gray-300 font-semibold">Layer 3 (Streak Stars)</span>
            </label>

            <div className="space-y-2 ml-6">
              <div>
                <label className="block text-xs text-gray-400 mb-1">Speed: {config.starSpeed3.toFixed(1)}x</label>
                <input
                  type="range"
                  min="0.1"
                  max="20"
              ...
              <div>
                <label className="block text-xs text-gray-400 mb-1">Density: {config.starFrequency3}</label>
                <input
                  type="range"
                  min="10"
                  max="500"
              ...
              <div>
                <label className="block text-xs text-gray-400 mb-1">Size: {config.starScale3.toFixed(1)}x</label>
                <input
                  type="range"
                  min="0.1"
                  max="3"
              ...
              <div>
                <label className="block text-xs text-gray-400 mb-1">Line Length: {config.lineLength3}</label>
                <input
                  type="range"
                  min="0"
                  max="200"
                  ...
                  onChange={(e) => updateConfig('lineLength3', parseInt(e.target.value))}
                  className="w-full"
                />
              </div>

              <div>
                <label className="block text-xs text-gray-400 mb-1">Brightness: {config.brightness3.toFixed(1)}</label>
                <input
                  type="range"
                  min="0"
                  max="1"
              ...
              <div>
                <label className="block text-xs text-gray-400 mb-1">Spawn Delay: {config.spawnDelay3}ms</label>
                <input
                  type="range"
                  min="0"
                  max="500"
              ...
              <div>
                <label className="block text-xs text-gray-400 mb-1">Twinkle Amount: {config.twinkleAmount3}%</label>
                <input
                  type="range"
                  min="0"
                  max="100"
              ...
              <div>
                <label className="block text-xs text-gray-400 mb-1">Twinkle Speed: {config.twinkleSpeed3.toFixed(1)}x</label>
                <input
                  type="range"
                  min="0.1"
                  max="5"
              ...
              <div>
                <label className="block text-xs text-gray-400 mb-1">Speed Randomness: {config.twinkleSpeedRandomness3}%</label>
                <input
                  type="range"
                  min="0"
                  max="100"
              ...
              <div>
                <label className="block text-xs text-gray-400 mb-1">Size Randomness: {config.sizeRandomness3}%</label>
                <input
                  type="range"
                  min="0"
                  max="100"
