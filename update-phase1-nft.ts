...
async function updatePhase1() {
  ...
  const phaseI = cards.find((card: any) => card.order === 1 && card.title === "Foundation");
...
If you are one of the 40 Phase I beta testers, here is a commemorative NFT which officially stamps your "ground floor" involvement.`;
  ...
  console.log("✓ Phase I description updated with NFT sentence");
}
